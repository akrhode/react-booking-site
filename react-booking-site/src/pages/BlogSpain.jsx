  ...
  return (
    <div>
      ...
      <div className="grid grid-rows-none md:grid-cols-5 pt-8 pb-16 pl-8 pr-8 gap-2 md:gap-4">
        ...
        <img
          className="w-full h-full object-cover"
          src="https://cdn.pixabay.com/photo/2020/03/12/21/34/fun-4926289_1280.jpg"
          alt="Park Guell Barcelona"
        />

        <img
          className="w-full h-full object-cover"
          src="https://images.pexels.com/photos/14234129/pexels-photo-14234129.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=22"
